...
public class SurfaceViewRenderer extends SurfaceView
    ...
    private VideoRenderer.I420Frame myFrame;
    ...
    public void saveFrame(final String extension, final File output) {

        final Promise myPromise = this.promise;
        ...
        runOnRenderThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    myPromise.resolve(uri);
                } catch (FileNotFoundException e) {
                    myPromise.reject(ERROR_UNABLE_TO_SNAPSHOT, "Failed to capture view snapshot");
                }
